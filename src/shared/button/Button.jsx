...
const Button = ({
  ...
  const baseStyle =
    "inline-flex items-center justify-center gap-2 px-5 py-2  rounded-xl font-medium transition-all duration-300";

  const variants = {
    primary: "bg-[#CAEB66] text-black hover:bg-[#02363b]",
    outline:
